...
@media screen and (min-width:1px) and (max-width: 500px) {
  ...
  <div class="taskbar">
    ...
    <a href="world.php"><img class="world" src="globe.png"/></a>
  ...
  <br>
  <form method="POST" enctype="multipart/form-data">
      <button class="fbuttons" name="end">end</button>
      <button class="fbuttons" name="best">best</button>
</form>
    ...
    <?php 
      ...
      echo '<a href="img_post.php"><img class="icon_add_post" src="40-add-card-outline.png" /></a>';
        ...
        //get data from posts best or end
        if($chose==1){
            $publish = $database->prepare("SELECT * FROM `posts` ORDER BY `like` DESC ");
          $publish ->execute();
          
        }
        if($chose==0){
          $publish = $database->prepare("SELECT * FROM posts ORDER BY id DESC ");
          $publish ->execute();
        } 
        //object become array 

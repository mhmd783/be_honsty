...
<html>
  ...
  <div class="div1"> 
        ...
        $puplish_notfans=$database->prepare("SELECT * FROM d_like WHERE post_id=$id_post"); 
        $puplish_notfans->execute();
        echo '<h1>.....Not_Fans.....</h1>';
        foreach($puplish_notfans AS $notfans){
            $client_id=$notfans['client_data'];
